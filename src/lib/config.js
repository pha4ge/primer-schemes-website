...
export const CATALOG_REPO_OWNER = 'ChrisgKent'; // TODO: 'pha4ge' once main is migrated
export const CATALOG_REPO_NAME = 'pha4ge-primer-schemes'; // TODO: 'primer-schemes' under pha4ge
export const CATALOG_REPO_BRANCH = 'migration'; // TODO: 'main'
